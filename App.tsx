...
import { I18nContext, translations, Language, TranslationKey } from './i18n';
...
const App: React.FC = () => {
  ...
  const lang: Language = settings.language || 'sk';
  ...
  const handleAddProfile = () => {
    ...
    const newProfile = { ...DEFAULT_PROFILE, id: newId, name: `${t('newGameDefaultName')} ${newId}` };
  ...
  const TABS = [
    { id: 'profiles', label: t('profilesTab'), icon: Gamepad2 },
    { id: 'ops', label: t('opsTab'), icon: Wrench },
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full">
          ...
          <header className="bg-slate-900 border-b border-slate-800 h-16 flex items-center justify-between px-6 shrink-0 gap-6">
            ...
            <div className="flex items-center gap-3 min-w-fit">
               ...
               <h1 className="text-xl font-bold tracking-tight text-white hidden lg:block">{t('appTitle').split('UE5 Zen')[0]}<span className="text-blue-500">UE5 Zen</span> Tool</h1>
            </div>
               ...
               <div className="flex bg-slate-950 p-1 rounded-lg border border-slate-800 shadow-sm w-full">
                  ...
                  >
                     ...
                     <div className="flex flex-col items-start leading-none">
                        <span>Retoc</span>
                        <span className="text-[9px] opacity-80 font-normal">{t('legacy')}</span>
                     </div>
                  </button>
                  <button 
                  ...
                  >
                     ...
                     <div className="flex flex-col items-start leading-none">
                        <span>Castoc</span>
                        <span className="text-[9px] opacity-80 font-normal">{t('modern')}</span>
                     </div>
                  </button>
               </div>
            </div>
